...
- (void)SSDKSetupWeChatParamsByTitle:(id)arg1 description:(id)arg2 webpageUrl:(id)arg3 path:(id)arg4 thumbImage:(id)arg5 userName:(id)arg6 forPlatformSubType:(unsigned long long)arg7;
