...
@interface WFHotWeiboModel : TTURLRequestModel <WFImagePreloadableModel>
{
...
@property(readonly, nonatomic) long long newWeiboCount; // @synthesize newWeiboCount=_newWeiboCount;
