...
@interface WFHisPostsModel : TTURLRequestModel
{
    int _weiboType;
    NSString *_uid;
...
- (id)initWithType:(int)arg1 uid:(id)arg2;
...
@property(readonly, nonatomic) long long postTotal; // @synthesize postTotal=_postTotal;
