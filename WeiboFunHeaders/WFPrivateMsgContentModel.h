...
@interface WFPrivateMsgContentModel : TTURLRequestModel
{
    long long _cid;
...
- (id)initWithDialogId:(long long)arg1;
...
@property(readonly, nonatomic) long long msgTotal; // @synthesize msgTotal=_msgTotal;
