...
@class MBProgressHUD, NSArray, NSString, QLTextField, UILabel, UIView, WFComment;

__attribute__((visibility("hidden")))
@interface WFCommentReportController : WFUITableController <UITextViewDelegate, MBProgressHUDDelegate>
{
    WFComment *_comment;
