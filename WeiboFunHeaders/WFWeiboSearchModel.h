...
@interface WFWeiboSearchModel : TTURLRequestModel
{
    int _weiboType;
    NSString *_keyword;
    _Bool _fromHot;
...
- (id)initWithType:(int)arg1 keyword:(id)arg2 fromHot:(_Bool)arg3;
@property(readonly, nonatomic) _Bool isShowingAlbums;
@property(readonly, nonatomic) _Bool isShowingResults; // @synthesize isShowingResults=_isShowingResults;
...
@property(readonly, nonatomic) long long resultTotal; // @synthesize resultTotal=_resultTotal;
